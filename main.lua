...
function love.draw()
  ...
  love.graphics.draw( player.sprite, player.body:getX(), player.body:getY(), nil, player.direction, 1, player.centerX, player.centerY );

  -- Draw coins animations
  for i, c in ipairs( coins ) do
